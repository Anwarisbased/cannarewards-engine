...
final class UserProfile {
    ...
    public function add_custom_fields(WP_User $user) {
        ?>
        ...
        <table class="form-table" id="cannarewards-custom-fields">
            <tr>
                ...
                <td>
                    <?php 
                    $this->fieldFactory->render_text_input('phone_number', $this->wp->getUserMeta($user->ID, 'phone_number', true), [
                        'class' => 'regular-text'
                    ]); 
                    ?>
                </td>
            ...
            <tr>
                ...
                <td>
                    <?php 
                    $this->fieldFactory->render_checkbox('marketing_consent', (bool) $this->wp->getUserMeta($user->ID, 'marketing_consent', true), [
                        'description' => 'User agreed to receive marketing communications.'
                    ]); 
                    ?>
                </td>
            </tr>
        ...
        <table class="form-table" id="cannarewards-shipping-fields">
             <tr>
                ...
                <td>
                    <?php 
                    $this->fieldFactory->render_text_input('shipping_first_name', $this->wp->getUserMeta($user->ID, 'shipping_first_name', true), [
                        'class' => 'regular-text'
                    ]); 
                    ?>
                </td>
            ...
            <tr>
                ...
                <td>
                    <?php 
                    $this->fieldFactory->render_text_input('shipping_last_name', $this->wp->getUserMeta($user->ID, 'shipping_last_name', true), [
                        'class' => 'regular-text'
                    ]); 
                    ?>
                </td>
            ...
            <tr>
                ...
                <td>
                    <?php 
                    $this->fieldFactory->render_text_input('shipping_address_1', $this->wp->getUserMeta($user->ID, 'shipping_address_1', true), [
                        'class' => 'regular-text'
                    ]); 
                    ?>
                </td>
            ...
            <tr>
                ...
                <td>
                    <?php 
                    $this->fieldFactory->render_text_input('shipping_city', $this->wp->getUserMeta($user->ID, 'shipping_city', true), [
                        'class' => 'regular-text'
                    ]); 
                    ?>
                </td>
            ...
            <tr>
                ...
                <td>
                    <?php 
                    $this->fieldFactory->render_text_input('shipping_state', $this->wp->getUserMeta($user->ID, 'shipping_state', true), [
                        'class' => 'regular-text'
                    ]); 
                    ?>
                </td>
            ...
            <tr>
                ...
                <td>
                    <?php 
                    $this->fieldFactory->render_text_input('shipping_postcode', $this->wp->getUserMeta($user->ID, 'shipping_postcode', true), [
                        'class' => 'regular-text'
                    ]); 
                    ?>
                </td>
