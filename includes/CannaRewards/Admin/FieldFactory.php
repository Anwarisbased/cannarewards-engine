...
final class FieldFactory {
    ...
    public function render_select(string $name, string $value, array $options, array $args = []): void {
        printf(
    ...
    public function render_textarea(string $name, string $value, array $args = []): void {
        printf(
            '<textarea id="%s" name="%s" class="%s" rows="%d">%s</textarea>',
            esc_attr($args['id'] ?? $name),
            esc_attr($name),
            esc_attr($args['class'] ?? 'regular-text'),
    ...
    public function render_checkbox(string $name, bool $value, array $args = []): void {
        printf(
