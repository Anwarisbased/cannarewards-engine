...
final class AdminMenu {
    ...
    public function personality_section_callback() { echo '<p>Define the core language and feel of your rewards program to match your brand\'s voice.</p>'; }
    public function theme_section_callback() { echo '<p>Control the PWA\'s visual appearance. Use HSL values (e.g., "222.2 47.4% 11.2%") for colors, as defined in <code>globals.css</code>. Leave fields blank to use the PWA\'s default styling.</p>'; }
    ...
    public function qr_generator_page_html() {
        if (!current_user_can('manage_options')) { return; }
