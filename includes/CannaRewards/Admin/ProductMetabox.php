        ...
        <table class="form-table">
            <tbody>
                <tr>
                    ...
                    <td>
                        <?php 
                        $this->fieldFactory->render_text_input('canna_points_award', $points_award, [
                            'type' => 'number',
                            'class' => 'short',
                            'description' => 'Enter the number of base points a user receives for scanning this product\'s QR code.'
                        ]); 
                        ?>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <?php 
                        $this->fieldFactory->render_text_input('canna_points_cost', $points_cost, [
                            'type' => 'number',
                            'class' => 'short',
                            'description' => 'Enter the number of points required to redeem this item. Leave blank if this product cannot be redeemed.'
                        ]); 
                        ?>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        ...
                        $this->fieldFactory->render_select('canna_required_rank', $required_rank_slug, $rank_options, [
                            'description' => 'Select the minimum rank a user must have to see and redeem this reward.'
                        ]);
                        ?>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <?php 
                        $this->fieldFactory->render_textarea('canna_marketing_snippet', $marketing_snippet, [
                            'rows' => 3,
                            'class' => 'large-text',
                            'description' => 'A short, pre-approved marketing line for this product. This is sent to Customer.io on scan events.'
                        ]); 
                        ?>
                    </td>
                </tr>
