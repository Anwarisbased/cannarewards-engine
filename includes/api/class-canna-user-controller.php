...
class Canna_User_Controller {
    ...
    // =========================================================================
    // CALLBACK METHODS (Copied from the original controller)
    // =========================================================================
    ...
    public static function register_user(WP_REST_Request $request) {
        ...
        if (!empty($params['code'])) {
            ...
            // We need to call the method from the other controller.
            // Assuming it will be available when this is called.
